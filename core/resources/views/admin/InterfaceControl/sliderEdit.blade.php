...
@section('content')
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-bars"></i> Edit slider</h1>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    <form action="{{route('admin.slider.update',$slider->id)}}" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                     <div class="col-md-6 col-lg-5">
                                      <div class="form-group">
                                          ...
                                          <div class="input-group">
                                              <input type="text" name="title" value="{{$slider->title}}" class="form-control form-control-lg">
                                          </div>
                                      </div>
                                     </div>
                                     <div class="col-md-6 col-lg-7">
                                         <div class="form-group">
                                             ...
                                             <div class="input-group">
                                                 <input type="text" name="subtitle" value="{{$slider->subtitle}}"  class="form-control form-control-lg">
                                             </div>
                                         </div>
                                     </div>
                                     <div class="col-md-6 col-lg-5">
                                         <div class="form-group">
                                             ...
                                             <div class="input-group">
                                                 <input type="text" name="btn_name" value="{{$slider->btn_name}}"  class="form-control form-control-lg">
                                             </div>
                                         </div>
                                     </div>
                                     <div class="col-md-6 col-lg-7">
                                         <div class="form-group">
                                             ...
                                             <div class="input-group">
                                                 <input type="text" name="btn_link" value="{{$slider->btn_link}}"  class="form-control form-control-lg">
                                             </div>
                                         </div>
                                     </div>
                                        ...
                                        <h5> <label for="exampleInputEmail1">Banner</label></h5>
                                            ...
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail" style="max-width: 1920px; max-height: 800px;">
                                                    <img src="{{asset('assets/image/banner/'.$slider->banner)}}" alt="*" />
                                                </div>
